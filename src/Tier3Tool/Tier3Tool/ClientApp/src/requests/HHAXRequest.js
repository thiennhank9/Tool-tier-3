...
export default {
  ...
  getPatients(
    ...
    const objFormat = {
      agencyID,
      insertedDateFrom: !isNil(insertedDateFrom)
        ? insertedDateFrom.toJSON()
        : null,
      modifiedDateFrom: !isNil(modifiedDateFrom)
        ? modifiedDateFrom.toJSON()
        : null,
    ...
    return appRequest.post(
      "/HHAX/get-patients",
      { connection, patientSearch: objPatientSearch, paging },
      config
    );
  },
  getAuthorizations(
