...
export default class HHAXPatientsStore {
  ...
  @observable authorizationSearch = {};

  // Patients Results in table
  @observable isLoading = false;
  @observable authorizations = [];
  ...
  @action
  setAuthorizationSearch(authorizationSearch) {
  ...
  @action
  getSearchAuthorizations(connection, props) {
    this.setIsLoading();
